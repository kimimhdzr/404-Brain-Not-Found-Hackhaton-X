...
public class MentorSearchService {
    ...
    public List<MentorItem3Model> mentorSearch(Context context, String mentorName, String companyName, String jobIndustry) {
    ...
    public void mentorFilterSearch(Context context, String mentorLocation, String yoe, String jobIndustry, String jobLevel, FirestoreCallback callback) {
        List<MentorItem3Model> mentorList = new ArrayList<>();
    ...
    public List<MentorItem3Model> mentorSaved(Context context, String uid) {
        List<MentorItem3Model> mentorList = new ArrayList<>();
    ...
    public List<MentorItem3Model> mentorSavedSearch(Context context, String mentorName, String companyName, String jobIndustry) {
        List<MentorItem3Model> mentorList = new ArrayList<>();
